...
# --- REMOVE OUTLIERS ---
## Always check for null values after removal of outliers
...
EXPERIMENT   = 'Optimized with Outliers Removed'      # change 
...
# -------------------------------------------------------
X_TRAIN = x_train_filled                       # x_train_resampled if imbalance handled, # x_train_filled if outliers removed and class not balanced
Y_TRAIN = y_train                       # y_train_resampled if imbalance handled
X_TEST  = x_test_filled                       # x_test_filled if outliers removed
# ============================================================
