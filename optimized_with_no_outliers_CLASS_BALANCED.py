...
# --- STEP 1: SMOTE (fillna before SMOTE due to outlier removal creating NaNs) ---
print(f"\nBefore SMOTE: {y_train.value_counts().to_dict()}")
sm = SMOTE(random_state=42)
x_train_resampled, y_train_resampled = sm.fit_resample(x_train.fillna(x_train.median()), y_train)
...
# LogReg and SVC: pass x_test_filled directly, pipeline scales internally
# RFC and XGB: pass x_test_filled directly, no scaling needed
